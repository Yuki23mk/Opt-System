              ...
              <Table className="min-w-full">
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="bg-[#115e59] text-white px-1 py-1 sm:px-3 sm:py-2 text-[9px] sm:text-xs font-semibold text-center w-[60px] sm:w-[120px] whitespace-nowrap">操作</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                          ...
                          <TableCell colSpan={7} className="p-2 sm:p-4 bg-slate-50">
                            <Tabs defaultValue="documents">
                              <TabsList className="mb-2 sm:mb-4">
                                <TabsTrigger value="documents" className="text-[10px] sm:text-xs font-medium">関連資料</TabsTrigger>
                                <TabsTrigger value="materials" className="text-[10px] sm:text-xs font-medium">使用資材</TabsTrigger>
                              </TabsList>
