// app/password-reset/[token]/page.tsx - パスワードリセット設定ページ（共有コンポーネント条件対応版）
"use client";
...
export default function PasswordResetTokenPage() {
  ...
  // 🔧 共有コンポーネント（password.ts）に合わせたパスワード強度チェック
  const passwordChecks = {
    length: password.length >= 11, // 🆕 11文字以上に変更
