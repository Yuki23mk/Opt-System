            ...
            <>
              {cartStep === 'cart' && (
                <>
                    ...
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="bg-slate-50">
                          <th className="p-3 text-left font-semibold text-slate-700">製品名</th>
                          <th className="p-3 text-center font-semibold text-slate-700">容量</th>
                          <th className="p-3 text-center font-semibold text-slate-700">油種</th>
                          <th className="p-3 text-center font-semibold text-slate-700">数量</th>
                          <th className="p-3 text-center font-semibold text-slate-700">単価 (円・税抜)</th>
                          <th className="p-3 text-center font-semibold text-slate-700">金額 (円・税抜)</th>
                        </tr>
                      </thead>
                      <tbody>
                        {cartItems.map((item, idx) => (
                          <tr key={`${item.id}-${idx}`} className="border-t border-slate-100 hover:bg-slate-50/50">
                            ...
                            <td className="p-3 text-center">
                              <div className="flex items-center justify-center space-x-2">
                                <button
                                  ...
                                  className="hover:bg-slate-100 p-1 rounded transition-colors text-slate-600"
                                ...
                                <input
                                  ...
                                  className="w-16 border border-slate-200 px-2 py-1 text-center rounded text-sm focus:border-slate-400"
                                />
                                <button
                                  onClick={() => handleUpdateQuantity(item.id, item.quantity + 1)}
                                  className="hover:bg-slate-100 p-1 rounded transition-colors text-slate-600"
                            ...
                            <td className="p-3 text-center font-medium text-sm text-slate-800">
                  ...
                  {/* 合計とボタン */}
                  <div className="flex justify-between items-center mt-6 pt-4 border-t border-slate-200 bg-slate-50 px-4 py-3 rounded-lg">
                    ...
                    <div className="text-right">
                      ...
                      <Button 
                        className="bg-slate-700 hover:bg-slate-800 text-white text-sm px-6 py-2"
